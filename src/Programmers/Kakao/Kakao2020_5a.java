...
public class Kakao2020_5a {
	...
	static class Solution {
		...
		boolean 보설치가능(int x, int y) {
			...
			if (y == 0 || x == N - 1)
				return false;
			if (!기둥(x, y - 1) && !기둥(x + 1, y - 1) && !(보(x - 1, y) && 보(x + 1, y)))
				return false;
			return true;
		}
	...
	public static void main(String[] args) {
		...
		int[][] input2 = { { 0, 0, 0, 1 }, { 2, 0, 0, 1 }, { 4, 0, 0, 1 }, { 0, 1, 1, 1 }, { 1, 1, 1, 1 },
