...
public class Kakao2020_5b {
	...
	static class Solution {
		...
		boolean 설치가능(int x, int y, int a) {
			...
			if (a == 기둥) {
				if (y == N - 1)
					return false;
				if (y > 0 && !있나(x, y - 1, 기둥) && !있나(x - 1, y, 보) && !있나(x, y, 보))
					return false;
			} else if (a == 보) {
				if (y == 0 || x == N - 1)
					return false;
	...
	public static void main(String[] args) {
		...
		int[][] a1 = { { 1, 0, 0, 1 }, { 1, 1, 1, 1 }, { 2, 1, 0, 1 }, { 2, 2, 1, 1 }, { 5, 0, 0, 1 }, { 5, 1, 0, 1 },
				{ 4, 2, 1, 1 }, { 3, 2, 1, 1 } };
		int[][] a2 = { { 0, 0, 0, 1 }, { 2, 0, 0, 1 }, { 4, 0, 0, 1 }, { 0, 1, 1, 1 }, { 1, 1, 1, 1 }, { 2, 1, 1, 1 },
				{ 3, 1, 1, 1 }, { 2, 0, 0, 0 },
